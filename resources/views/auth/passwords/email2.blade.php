...
<body class="login">
	<div class="wrapper wrapper-login">
		...
		<div class="container container-login animated fadeIn">
            <a href="{{route('login')}}" style="margin-top: -15px; font-weight:bold; margin-bottom:20px;" class="btn btn-sm"><i class="fas fa-arrow-left"></i> &nbsp; Kembali</a>
			...
			<div class="login-form">
                ...
                @csrf
                    <div class="form-group form-floating-label">
                        <input id="email" name="email" type="email" class="form-control input-border-bottom @error('email') is-invalid @enderror" required>
                    ...
                    <div class="form-action">
                        <button type="submit" class="btn btn-primary btn-rounded btn-login">Send Reset Link</button>
                    </div>
                </form>
			</div>
		</div>
