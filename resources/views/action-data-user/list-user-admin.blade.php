				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{route('data.user.admin.index')}}">{{$title}}</a>
							</li>
						</ul>
					</div>
									...
									<div class="table-responsive">
										<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
											<div class="row">
												...
												<div class="col-sm-12 col-md-6">
													<form class="form" method="get" action="{{ route('cari.admin') }}">														
											...
											<div class="row">
												<div class="col-sm-12">
													<table id="add-row" class="display table table-striped table-hover dataTable" role="grid" aria-describedby="add-row_info">
                                                        ...
                                                        @empty
                                                            <tr>
                                                                <td colspan="7" class="text-center">Data User Admin Belum Ada.</td>
                                                            </tr>
														@endforelse
														</tbody>
													</table>
									...
									<div class="table-responsive">
										<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
													...
													<table id="add-row" class="display table table-striped table-hover dataTable" role="grid" aria-describedby="add-row_info">
														...
														<tbody>	
                                                            @forelse($user as $row)
                                                                @if($row->role == 'User')
                                                                <tr role="row">
                                                                    <td style="text-align: center;"><img src="{{url('storage/'.$row->img)}}" alt="..." style="max-width: 100px !important; border-radius:5px" class="img-fluid"></td>
                                                                    <td>{{$row->name}}</td>
                                                                    <td>{{$row->username}}</td>																
                                                                    <td>{{$row->email}}</td>
                                                                    <td>{{$row->role}}</td>
                                                            ...
                                                            @empty
                                                                <tr>
                                                                    <td colspan="6" class="text-center">Data User Admin Belum Ada.</td>
                                                                </tr>
                                                            @endforelse
														</tbody>
													</table>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-5">
                                                    <div class="dataTables_info" id="add-row_info" role="status" aria-live="polite">
                                                        Menampilkan &nbsp;&nbsp; <strong>5</strong> &nbsp;&nbsp; sampai &nbsp;&nbsp; <strong>10</strong> &nbsp;&nbsp; dari &nbsp;&nbsp; <strong>10</strong> &nbsp;&nbsp; data.
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-7">
                                                    <div class="dataTables_paginate paging_simple_numbers mt-2" id="add-row_paginate">
