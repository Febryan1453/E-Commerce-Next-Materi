	...
	<div class="page-inner">
		<div class="page-header">
			...
			<ul class="breadcrumbs">
				...
				<li class="nav-item">
					<a href="{{route('transaksi.index')}}">Pending</a>
				</li>
			</ul>
		</div>
		<div class="row">
						...
						<div class="table-responsive">
							<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
								<div class="row">
									...
									<div class="col-sm-12 col-md-6">
										<form class="form" method="get" action="{{ route('transaksi.cari.pesanan') }}">
												...
												<tr role="row" class="odd text-center">
													...
													<td>
														<div class="form-button-action">
															...
															<a style="cursor:pointer ;" data-target="#Pending{{$row->id}}" data-toggle="modal" title="Update Status">
																<i class="fas fa-pen-square"></i>&nbsp; STATUS
															</a>

															@include('modal.pending-to-lunas')
