									...
									<div class="form">
										...
										<div class="form-group form-show-notify row">
											...
											<div class="col-lg-4 col-md-9 col-sm-8">
												<input value="{{ old('nama_produk') }}" type="text" name="nama_produk" class="@error('nama_produk') is-invalid @enderror form-control input-fixed" id="exampleInputPassword1">
												@error('nama_produk')
										...
										<div class="form-group form-show-notify row">
											...
											<div class="col-lg-4 col-md-9 col-sm-8">
												<input value="{{ old('harga') }}" type="text" name="harga" class="@error('harga') is-invalid @enderror form-control input-fixed" id="exampleInputPassword1">
												@error('harga')
												<div class="invalid-feedback" style="width: 300px !important;" role="alert">
													<strong>{{ $message }}</strong>
												</div>
										...
										<div class="form-group form-show-notify row">
											...
											<div class="col-lg-4 col-md-9 col-sm-8">
												<input value="{{ old('berat') }}" type="text" name="berat" class="@error('berat') is-invalid @enderror form-control input-fixed" id="exampleInputPassword1">
												@error('berat')
												<div class="invalid-feedback" style="width: 300px !important;" role="alert">
													<strong>{{ $message }}</strong>
												</div>
